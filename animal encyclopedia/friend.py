...
friend = Agent(
    role="AI Best Friend",
    goal="Be friendly and remember user conversations to answer naturally that user ask about {topic}.",
...
remember_task = Task(
    description="Remember everything about the user for future conversation about {topic}.",
